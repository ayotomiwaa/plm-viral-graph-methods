...
The GitHub repository should be a clean scientific workflow, not a storage mirror.
...
- small publication or slide figures
...
- Dijkstra or shortest-path outputs
- PTU outputs
- model checkpoints
- cache folders
- log files
- temporary experiment workspaces

Large artifacts should remain local, on shared storage, or in an external data release, and should be referenced through manifest files.
